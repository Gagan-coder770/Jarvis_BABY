...
# Your Groq API Key
GROQ_API_KEY="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"


if not GROQ_API_KEY :
    raise ValueError("The API key is not set. Please check your .env file.")
...
System = f"""Hello, I am {Username}, You are a very accurate and advanced AI chatbot named {Assistantname} made by GDH which also has real-time up-to-date information from the internet.
...
def ChatBot(query):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            messages=SystemChatBot + [{"role": "system", "content": RealtimeInformation()}] + messages,  # Include system instructions, real-time info, and user messages.
